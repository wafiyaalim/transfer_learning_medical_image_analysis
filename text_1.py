...
image_path = "D:/test/image_0578.jpg"  # Replace with your test image path

# Predict the angle for the test image
predicted_angle = predict_angle(image_path)
print(f"Predicted Angle: {predicted_angle:.4f}")
...
plt.imshow(image)
plt.title(f"Predicted Angle: {predicted_angle:.4f}°")
